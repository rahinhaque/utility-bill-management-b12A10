...
export default function Navbar() {
  ...
  return (
    <nav className="navbar bg-base-200 border-b px-4 md:px-8 sticky top-0 z-50 shadow-sm">
      <div className="flex-1">
        <Link
          to="/"
          className="text-xl md:text-2xl font-semibold tracking-wide text-gray-800 hover:text-blue-600 transition"
        >
      ...
      {menuOpen && (
        <div className="absolute top-16 left-0 w-full bg-base-100 border-t shadow-md flex flex-col items-start px-6 py-4 space-y-3 md:hidden">
          <NavLink
            to="/"
